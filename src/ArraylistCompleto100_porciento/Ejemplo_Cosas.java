 ...
 */
package ArraylistCompleto100_porciento;
 ...
 * @author Asus-PC
 */
public class Ejemplo_Cosas {

    int x = 0;

    public static void main(String[] args) {
        Ejemplo_Cosas admin = new Ejemplo_Cosas();
        admin.ejecutar(admin);
    }

    public void ejecutar(Ejemplo_Cosas admin) {
    ...
    public List<Cosas> crearLista(List<Cosas> pacientes, Cosas nueva, int a, Ejemplo_Cosas admin) {
        for (int i = 1; i <= a; i++) {
            ///x ++;
    ...
    public Cosas crearCosa(Ejemplo_Cosas admin, int a) {
    ...
    public void buscar(List<Cosas> pacientes, int a, String c, Ejemplo_Cosas admin) {
    ...
    public void Editar_todaInformacion(List<Cosas> pacientes, Cosas nueva, int a, Ejemplo_Cosas admin) {
        pacientes.clear();
        admin.crearLista(pacientes, nueva, a, admin);
    }

    public List<Cosas> eliminarTodo(List<Cosas> pacientes, Ejemplo_Cosas admin) {
        pacientes.clear();
    ...
    public List<Cosas>  agregarCosaAdicional(List<Cosas> pacientes,int a,  Ejemplo_Cosas admin,Cosas nueva) {
        int b=a;
        a=a+1;
       for ( b = 1; b <= a; b++) {
            ///x ++;
